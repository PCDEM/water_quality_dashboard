...
<!-- sciTaxa <- readxl::read_excel('Data/Pinellas_SCI.xlsx', sheet = 'Taxa Abundance') |> -->
<!--   dplyr::mutate(Date = as.Date(Date)) -->
...
<!--         ) -->
<!--     } -->
<!--   data <- dplyr::filter(bioData, WBID == strat) -->
<!--   return(data) -->
<!--   }) -->


<!-- bioP <- reactive({ -->
<!--   return(bioPlt(getBio(), bio = ifelse(getBio()$Bio[1] =='SCI Score', 'SCI', 'LVI'))) -->
<!-- }) -->
...
<!-- #   x = c(1, 2), -->
<!-- #   y = c(1, 1), -->
<!-- #   text = c("July 13, 2009", "45 (Healthy)"), -->
...
<!-- #     annotations = list( -->
<!-- #       list(x = 0, y = 0.7, -->
<!-- #            text = "<b>Datasource/Agency</b><br>FDEP Watershed Monitoring Section", -->
<!-- #            showarrow = FALSE, xanchor = "left"), -->
<!-- #       list(x = 0, y = 0.6, text = "<b>WIN/STORET Station</b><br>36312", -->
<!-- #            showarrow = FALSE, xanchor = "left"), -->
<!-- #       list(x = 0, y = 0.5, text = "<b>Station</b><br>Z4SL3003", -->
<!-- #            showarrow = FALSE, xanchor = "left"), -->
<!-- #       list(x = 0, y = 0.4, text = "<b>Survey</b><br>AMBIENT STATUS MONTR", -->
<!-- #            showarrow = FALSE, xanchor = "left") -->
<!-- #     ), -->
<!-- #     showlegend = FALSE -->
<!-- #   ) -->

...
The source content for this dashboard can be viewed on [Github](https://github.com/PCDEM){target="_blank"}.
...
High levels of *Enterococcus* can be the result of heavy rainfall or stormwater discharge, which can wash contaminants into coastal waters. When *Enterococcus* is elevated, it’s advisable to avoid swimming, particularly for people with open wounds or weakened immune systems. While Pinellas County collects this data to inform the public about water quality issues, the [FL Department of Health](https://www.floridahealth.gov/environmental-health/beach-water-quality/county-detail.html?County=Pinellas&Zip=33701-3109) remains the official source for updates and advisories about beach conditions and water safety.
...
fillCol(flex = c(0.06,0.05, 1),
  shinyWidgets::downloadBttn('datFull', paste0('Download Period of Record Data (',
                                              round(file.size('Data/New_Data.xlsx')/(1024^2),1),' Mb)'), 

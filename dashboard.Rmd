...
rtm <- leaflet::leaflet(options = leaflet::leafletOptions(zoomControl=FALSE)) |>
  ...
  leaflet::addScaleBar(
    ...
    leaflet::addControl(
    html = paste("<div style='font-size: 16px; color: red; font-weight: bold;'>Most recent sample:\n",unique(rDat$Date), "</div>"),
    position = "topleft"
  ) 
...
bm <- leaflet::leaflet(options = leaflet::leafletOptions(zoomControl=FALSE)) |>
  ...
  leaflet::addScaleBar(
    ...
    leaflet::addControl(
    html = paste("<div style='font-size: 16px; color: red; font-weight: bold;'>Most recent sample:",unique(eDat$Date),"</div>"),
    position = "topleft"
  ) 
